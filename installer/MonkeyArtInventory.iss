...
; Icono (intentar desde publish, si no existe, desde la publicación)
Source: "..\publish\MonkeyArtInventory\app.ico"; DestDir: "{app}"; Flags: ignoreversion; Tasks: ; Languages: ; Check: FileExists(ExpandConstant('{#SourcePath}\..\publish\MonkeyArtInventory\app.ico'))
